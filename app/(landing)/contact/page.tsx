...
import { FaGithub, FaInstagram, FaDiscord, FaWhatsapp, FaLinkedinIn } from "react-icons/fa";
...
const socialLinks = [
  ...
  { name: "WhatsApp", icon: FaWhatsapp, url: "https://wa.me/50664251906", hoverColor: "hover:text-[#25D366]" },
